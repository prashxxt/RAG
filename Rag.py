...
# Gemini-api-key
f = open('data.data//.api_key_dp.txt')
api_key = f.read()
...
embedding_model = GoogleGenerativeAIEmbeddings(google_api_key=api_key, model="modeeels//embedding-001")

# Set up a connection with the Chroma
connection = Chroma(persist_directory="data.data//Chroma_db_for_rag", embedding_function=embedding_model)
